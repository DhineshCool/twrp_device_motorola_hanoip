...
load_module "exfat.ko"    
load_module "fpc1020_mmi.ko"
load_module "fpsensor_spi_tee.ko"
load_module "ilitek_v3_mmi.ko"
load_module "mmi_annotate.ko"
load_module "mmi_info.ko"
load_module "mmi_sys_temp.ko"
load_module "moto_f_usbnet.ko"
load_module "mpq-adapter.ko"
load_module "mpq-dmx-hw-plugin.ko"
load_module "qpnp_adaptive_charge.ko"
load_module "rdbg.ko"
load_module "sensors_class.ko"
load_module "snd_smartpa_aw882xx.ko"
load_module "sx933x_sar.ko"
load_module "tzlog_dump.ko"
load_module "utags.ko"
load_module "watchdog_cpu_ctx.ko"
load_module "watchdogtest.ko"
